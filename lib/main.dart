...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List names = ["Смартфон Huawei Nova 11i", "Смартфон Huawei Nova y91", "Смартфон Huawei P60 Pro", "Смартфон Mate 50 Pro", "Смартфон Mate XS Pro"];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body: PageView.builder(
            ...
            itemBuilder: (context, index) {
              return Column(children: [
                ...
                Spacer(),
                SizedBox(width: 350,height: 40, child: OutlinedButton(
...
,                                  SizedBox(width: 350,height: 40, child: OutlinedButton(
                                        onPressed: () {},
                                        child: Text("Добавить в корзину",style: TextStyle(color: Colors.cyan)),style: OutlinedButton.styleFrom(
                    ...
                    style: OutlinedButton.styleFrom(
                        ...
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.all(
                          Radius.circular(15),
                        )), side: BorderSide(width: 5.0, color: Colors.cyan)))), SizedBox(height: 30,width: double.infinity,)
              ]);
            }));
  }
}
